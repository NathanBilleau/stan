...
<main>
    ...
    <p>
        Naviguez entre les différentes parties à l'aide des flèches <br>
    ...
    <Advice text="Pour une meilleure immersion, n'hésitez pas à porter un casque ou des écouteurs" />
</main>
